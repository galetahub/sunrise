...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<sunrise-core>, ["~> 0.1.1"])
      s.add_runtime_dependency(%q<sunrise-scaffold>, ["~> 0.1.1"])
    else
      s.add_dependency(%q<sunrise-core>, ["~> 0.1.1"])
      s.add_dependency(%q<sunrise-scaffold>, ["~> 0.1.1"])
    end
  else
    s.add_dependency(%q<sunrise-core>, ["~> 0.1.1"])
    s.add_dependency(%q<sunrise-scaffold>, ["~> 0.1.1"])
